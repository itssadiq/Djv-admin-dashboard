...
export const errorClass = "mt-1.5 text-xs text-red-500 font-medium";

export const checkboxClass =
  "w-5 h-5 rounded border-slate-300 text-brand-green focus:ring-brand-green cursor-pointer";
